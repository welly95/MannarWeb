...
class ContactUs extends StatefulWidget {
  ...
  ContactUs(this._lawyersList, this._filterData, this._aboutUsModel);
  @override
...
class _ContactUsState extends State<ContactUs> {
  ...
  void initState() {
    Future.delayed(Duration(seconds: 0)).then((_) async {
      ...
      BlocProvider.of<ServicesCubit>(context).getAboutUs();
    });
    super.initState();
  }
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    "بيانات شخصيه",
                                    style: TextStyles.textFieldsText.copyWith(fontSize: 13),
                            ...
                            SizedBox(
                              ...
                              child: BasicButton(
                                buttonName: 'ارسال',
                                onPressedFunction: () {
                                  print(userToken! + '----->' + messageController.text.trim());
                                  BlocProvider.of<ServicesCubit>(context)
                                      .contactUsSendingMessage(messageController.text.trim(), userToken!)
                                      .then((value) {
                                    if (value == true) {
                                      ...
                                      Fluttertoast.showToast(
                                        msg: 'هنالك خطأ في إرسال الرسالة، برجاء المحاولة في وقت لاحق',
                                        gravity: ToastGravity.TOP,
                                        toastLength: Toast.LENGTH_LONG,
                                        timeInSecForIosWeb: 5,
                                      );
